    ...
    <Layout>
        <div class="p-5">
            ...
            <div class="flex gap-3 justify-end mb-2">
                <router-link v-if="isProfesseur(user?.roles)" :to="{ name: 'assign-ec' }"
                    class="p-2 border rounded-lg text-white bg-sky-600">Assigner
                    une
                    matière</router-link>
                ...
                <template v-if="isProfesseur(user?.roles)">
                    <div class="w-full">
                        <div class="w-full overflow-auto border-l-slate-100 bg-white rounded shadow p-2 h-96">
                            <p class="font-semibold text-lg mt-3 ml-5 mb-5 text-sky-600">Listes des matières (enseignés
                                par
                                le
                                professeur)
                            </p>
